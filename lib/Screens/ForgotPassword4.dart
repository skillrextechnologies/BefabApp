              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: SvgPicture.asset("assets/images/tick.svg",color: Color(0xFF862633),width: 24,height: 24,),
                  )
                ),
              ),
              SizedBox(height: 16,),
...
Padding(
                ...
                child: Align(
                  alignment: Alignment.topLeft,
                  child: Text(
                    'Congratulations!. your password has been changed successfully. Now you can login with new password',
                    style: GoogleFonts.inter(
                      fontSize: 14,
